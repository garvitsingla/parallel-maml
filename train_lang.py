...
def main():
    ...
    }, f"lang_model/lang_policy_{model}_{room_size}_{num_dists}_{max_steps}_{delta_theta}_{num_batches}.pth")

    # Save the vectorizer
    with open(f"lang_model/vectorizer_lang_{model}_{room_size}_{num_dists}_{max_steps}_{delta_theta}_{num_batches}.pkl", "wb") as f:
        pickle.dump(vectorizer, f)

    print("Meta-training for lang-based policy finished")
