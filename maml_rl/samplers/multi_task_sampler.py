...
# ----------------------------------------------------------------------------------------
    ...
    def work_single_task(self, index, num_steps=1, fast_lr=0.5, gamma=0.95, gae_lambda=1.0, device='cpu'):
        ...
        # envs = SyncVectorEnv(
        #     [make_env(self.env_name, env_kwargs=self.env_kwargs) for _ in range(self.batch_size)],
        ...
        # Do the actual training and validation sampling
        params = None
        train_episodes_all = []
...
class SamplerWorker(mp.Process):
    def __init__(self,
        ...
        # self.envs.reset(seed=None if (seed is None) else seed + index * batch_size)
